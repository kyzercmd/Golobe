...
export const FindDestinationSearch = () => {
  return (
    <section className="xl:max-w-308 max-w-11/12 mx-auto flex flex-col gap-6 py-8 px-6 rounded-2xl shadow-[0px_4px_16px_0px_rgba(17,34,17,0.05)] bg-white">
      <div>
        <h1 className="font-semibold sm:text-[20px] text-lg text-[#112211]">
      ...
      <div className="flex justify-end sm:gap-6 flex-col sm:flex-row">
        ...
        <div className="flex gap-1 items-center px-4 py-3 bg-[#8DD3BB] rounded-sm justify-center">
          ...
          <p className="text-[14px] text-[#112211] font-medium">Show Places</p>
        </div>
      </div>
    </section>
  );
