      ...
      <div className="max-w-full">
        <div className="relative">
          <picture>
            ...
            <img
              className="object-cover md:h-156 sm:h-100 h-90 w-full text-[0px]"
              src={HeroBgjpg}
              alt="Luxury Traveling Commodities"
            ></img>
          </picture>
          <div className="absolute inset-0 bg-linear-to-r from-[#00234D]/63 to-[#00234D]/0"></div>
          <div className="absolute inset-0 max-w-360 mx-auto">
            <div className="flex flex-col md:mx-31.5 mx-10 my-20 gap-2 h-50.75 max-w-110">
