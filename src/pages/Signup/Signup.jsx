...
export const Signup = () => {
  return (
    <section className="min-h-screen overflow-hidden max-w-full mx-auto md:p-26 px-10 py-26 flex justify-between bg-white">
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col gap-10 mt-12">
            ...
            <div className="flex items-center w-full gap-4">
              ...
              <span className="text-[#112211]/50 text-sm">Or Sign up with</span>
              <div className="flex-1 border-t border-[#112211]/25"></div>
            </div>
